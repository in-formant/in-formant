...
DECL_FFT_IMPL(rfft, double, double, fftw_plan_r2r_1d(n, s.in, s.out, FFTW_REDFT00, FFTW_PLAN_METHOD))
DECL_FFT_IMPL(irfft, double, double, fftw_plan_r2r_1d(n, s.in, s.out, FFTW_REDFT00, FFTW_PLAN_METHOD))
...
DECL_FFT_IMPL(dct, double, double, fftw_plan_r2r_1d(n, s.in, s.out, FFTW_REDFT10, FFTW_PLAN_METHOD))
DECL_FFT_IMPL(idct, double, double, fftw_plan_r2r_1d(n, s.in, s.out, FFTW_REDFT01, FFTW_PLAN_METHOD))
