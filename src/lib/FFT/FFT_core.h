...
static void drfti1 (int n, FFT_DATA_TYPE * wa, int *ifac)
{
...
static void rffti (int n, FFT_DATA_TYPE * wsave, int *ifac)
{
...
/* void cosqi(int n, FFT_DATA_TYPE *wsave, int *ifac){ static
   double pih = 1.57079632679489661923132169163975; static int k;
   static double fk, dt;
...
static void dradf2 (int ido, int l1, FFT_DATA_TYPE * cc, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * wa1)
{
    int i, k;
    double ti2, tr2;
...
static void dradf4 (int ido, int l1, FFT_DATA_TYPE * cc, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * wa1,
...
static void dradfg (int ido, int ip, int l1, int idl1, FFT_DATA_TYPE * cc, FFT_DATA_TYPE * c1,
...
static void drftf1 (int n, FFT_DATA_TYPE * c, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * wa, int *ifac)
{
    int i, k1, l1, l2;
    int na, kh, nf;
...
static void dradb2 (int ido, int l1, FFT_DATA_TYPE * cc, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * wa1)
{
    int i, k, t0, t1, t2, t3, t4, t5, t6;
    double ti2, tr2;
...
static void dradb3 (int ido, int l1, FFT_DATA_TYPE * cc, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * wa1,
                    FFT_DATA_TYPE * wa2)
{
...
static void dradb4 (int ido, int l1, FFT_DATA_TYPE * cc, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * wa1,
                    FFT_DATA_TYPE * wa2, FFT_DATA_TYPE * wa3)
{
...
static void dradbg (int ido, int ip, int l1, int idl1, FFT_DATA_TYPE * cc, FFT_DATA_TYPE * c1,
                    FFT_DATA_TYPE * c2, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * ch2, FFT_DATA_TYPE * wa)
{
    static double tpi = 6.28318530717958647692528676655900577;
...
static void drftb1 (int n, FFT_DATA_TYPE * c, FFT_DATA_TYPE * ch, FFT_DATA_TYPE * wa, int *ifac)
{
    int i, k1, l1, l2;
    int na;
